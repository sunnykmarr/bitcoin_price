...
object Main extends App
{
    ...
    val route =
        ...
        println(s"1. To get the bitcoin price of last week: http://localhost:8080/lastWeekPrice")
        println(s"2. To get the bitcoin price of last month: http://localhost:8080/lastMonthPrice")
        println(s"3. To get the bitcoin price between two custom dates http://localhost:8080/customPrice?start=2018-12-20&end=2018-12-28")
        println(s"4. To get the n days moving average between two custom dates http://localhost:8080/movavg?start=2018-12-15&end=2018-12-28&n=2")
        println(s"5. To get the next 15 days prediction of the bitcoin prices http://localhost:8080/predictPrice")
